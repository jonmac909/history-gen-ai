...
import { Image, Upload, X, Loader2, Download, Sparkles } from "lucide-react";
...
export function ThumbnailGenerator({ projectId, projectTitle }: ThumbnailGeneratorProps) {
  // Upload state
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-lg font-semibold text-foreground">Generate Thumbnails</h2>
      </div>
